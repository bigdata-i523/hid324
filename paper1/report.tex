...
\begin{abstract}
Big data and its technologies helps in augmenting and improving the current Block chain technology and overcome  the problems around it.
\end{abstract}

\keywords{i523, hid324, Bigdata, Blockchain, Cryptocurrency, Bitcoin, Transaction, Smartchain}
...
For an instance, Kafka can handle up to 200,000 messages/second (220MB/second)\cite{kafka-performance}, which is way more than any other existing banking can provide.
